                        ...
                        <div class="card card-body">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="image" value="<?php echo $data[0]['image']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Text area</label>
                                    <textarea class="form-control" rows="5" name="description"><?php echo $data[0]['description']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea id="blog" class="form-control" rows="5" name="content" ><?php echo $data[0]['content']; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
